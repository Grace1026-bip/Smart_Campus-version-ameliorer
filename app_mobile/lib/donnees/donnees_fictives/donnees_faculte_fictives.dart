...
class MockFacultyData {
  static const users = <UserRole, FacultyUser>{
    UserRole.administrator: FacultyUser(
      ...
      avatarText: 'NK',
      matricule: 'ADM-001',
      promotion: 'Toutes promotions',
      phone: '+243 810 000 104',
      location: 'Campus FASI, bloc administratif',
    ),
    UserRole.apparitor: FacultyUser(
      name: 'Jean Lukusa',
      email: 'apparitor@smartfaculty.cd',
      role: UserRole.apparitor,
      department: 'Apparitorat academique',
      avatarText: 'JL',
      matricule: 'APP-014',
      promotion: 'Toutes promotions',
      phone: '+243 815 310 010',
      location: 'Bureau apparitorat',
    ),
  ...
  static final grades = [
    ...
    CourseGrade(
      ...
      published: true,
      locked: false,
      publishedAt: DateTime(2026, 5, 26),
    ),
    CourseGrade(
  ...
  static const riskStudents = [
    RiskStudent(
      ...
      reason: 'Attention : moyenne faible dans un cours du semestre.',
    ),
    RiskStudent(
      name: 'Noah Kanku',
      promotion: 'L2 Informatique',
    ...
    RiskStudent(
      name: 'Mireille Nzuzi',
      promotion: 'L1 Informatique',
      course: 'Introduction aux systemes',
      teacher: 'Ir. Michel Lukusa',
      average: 10.2,
      failures: 3,
      level: RiskLevel.medium,
  ...
  static const apparitorInsights = [
    ApparitorInsight(
      title: 'Reclamations en attente',
      detail: '12 reclamations sont encore en attente de traitement.',
      metric: '12',
      tone: NotificationTone.warning,
    ),
    ApparitorInsight(
      title: 'Notes non publiees',
      detail: 'Les notes de Programmation Web L2 ne sont pas encore publiees.',
      metric: 'L2',
      tone: NotificationTone.danger,
    ),
    ApparitorInsight(
      title: 'Risque eleve',
      detail: '5 etudiants sont a risque eleve en L1.',
      metric: '5',
      tone: NotificationTone.danger,
    ),
    ApparitorInsight(
      title: 'Livrables manquants',
      detail: '3 projets de L3 n ont pas encore de livrable depose.',
      metric: '3',
      tone: NotificationTone.info,
    ),
  ];
